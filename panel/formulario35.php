...
<html lang="es">
	<head>
		...
		<title>Formulario | Precios</title>
	</head>
	<body>
		<header>
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <form id="form-validation" style="display: inline" name="form1" action="operaciones.php" method="post" enctype="multipart/form-data">
                    		...
                    		<input type="hidden" name="seccion" value="35">
		                    		...
		                    		<div class="tab-content">
							                    			...
							                    			<div class="row">
                                                                ...
                                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							                    					<div class="input-group espacios">
											                        	...
											                        	<input type="text" name="nombreEn" data-validate="true" class="form-control" placeholder="Ingresa punto de destino" value="<?=$temporal -> datos -> nombreEn?>">
											                        </div>
							                    				</div>
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="galeria">
		                    				...
		                    				<div class="row" id="sortableImg">
							                    <?php
							                    $galeria = $temporal -> listaGaleria('en', '35');
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="caracteristicas">
		                    				...
		                    				<div class="row" id="preview-resenias">
		                    					<?php
		                    					$resenias = $temporal -> listaResenia('en', '35');
		                    					if (count($resenias) > 0) {
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="info">
		                    				<br>
		                    				<?php $temporal -> obtenerTarifa('en', '35'); ?>
		                    				<div class="row">
