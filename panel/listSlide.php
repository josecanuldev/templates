...
if($tipo==1){$texto="Transporte 35 USD";}else if($tipo==2){$texto="Transporte privado";}else if($tipo==3){$texto="Tours dentro de Holbox";}else if($tipo==4){$texto="Tours fuera de Holbox";}
else if($tipo==5){$texto="Nosotros";}
$temporal = new slide();
				                              	...
				                              	<td>
				                               	...
				                               	<td>
				                                	<div class="edit manita" data-id="<?=$elementoTemporal['idSlide']?>" data-titulo="<?=$elementoTemporal['titulo']?>" data-tituloEn="<?=$elementoTemporal['tituloEn']?>" data-ruta="<?=$elementoTemporal['imgPortada']?>" data-link="<?=$elementoTemporal['link']?>" data-linkVideo="<?=$elementoTemporal['linkVideo']?>" data-descripcion="<?=$elementoTemporal['descripcion']?>" data-descripcionEn="<?=$elementoTemporal['descripcionEn']?>" data-textoBoton="<?=$elementoTemporal['textoBoton']?>" data-textoBotonEn="<?=$elementoTemporal['textoBotonEn']?>" data-rutaMovil="<?=$elementoTemporal['imgMovil']?>">
				                                		<img src="../img/imgSlide/<?=$elementoTemporal['imgPortada']?>" class="img-responsive">
				                                	<div>
				                                </td>
				                                <td>
				                                	<div class="edit manita" data-id="<?=$elementoTemporal['idSlide']?>" data-titulo="<?=$elementoTemporal['titulo']?>" data-tituloEn="<?=$elementoTemporal['tituloEn']?>" data-ruta="<?=$elementoTemporal['imgPortada']?>" data-link="<?=$elementoTemporal['link']?>" data-linkVideo="<?=$elementoTemporal['linkVideo']?>" data-descripcion="<?=$elementoTemporal['descripcion']?>" data-descripcionEn="<?=$elementoTemporal['descripcionEn']?>" data-textoBoton="<?=$elementoTemporal['textoBoton']?>" data-textoBotonEn="<?=$elementoTemporal['textoBotonEn']?>" data-rutaMovil="<?=$elementoTemporal['imgMovil']?>">
		    		...
		    		<div class="modal-content">
		    			...
		    			<div class="modal-body">
		    				<center class="espacios">
								...
								<input type="file" onchange="showMyImageWH('preview-slide', this, '', 1, 1920, 1080)" name="imagen" id="" class="filestyle" data-input="false" data-buttonText="Imagen Principal" data-iconName="fa fa-picture-o" data-badge="false" data-type-file="imagen" data-validate="true" data-text="Imagen Principal">
								<p class="help-block">Solo se aceptan imágenes con formato .JPG, .JPEG, .PNG; La imagen debe ser menor a 8 MB. <br> La resolución óptima para esta imagen es de 1920x1080 </p>
							</center>
