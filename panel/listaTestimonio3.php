...
$listaTemporal = $temporal -> listaTestimonio(1, false, '');
// print_r($listaTemporal);
// exit;

$clave  = 'p_add_testimonio3';
$clave2 = 'p_del_testimonio3';
$clave3 = 'p_acdc_testimonio3';
$clave4 = 'p_sort_testimonio3';
$clave5 = 'p_mod_testimonio3';
$sort   = "testimonio3";
$handle = "";
...
<html lang="es">
                    		...
                    		<div class="">
		                        ...
		                        <div class="col-md-6 col-xs-12 col-md-pull-6">
		                            <ul class="ulfiltros">
		                                ...
		                                <li class="lifiltros">
		                                    <button type="submit" class="buttonaplicar" name="operaciones" value="operatestimonio3">Aplicar</button>
		                                </li>
		                            </ul>
		                        </div>
		                    </div>
		    		...
		    		<div class="modal-content">
		    			...
		    			<div class="modal-body">
		    				<center class="espacios">
								...
								<p class="help-block"><small>Solo se aceptan imagenes con formato .JPG, .JPEG, .PNG; La imagen debe ser menor a 3 MB. <br> La resolución óptima para esta imagen es de 1920 x 1080px </small></p>
							</center>
							<!-- <center class="espacios">
		    				...
		    				<div class="input-group espacios">
			                    ...
			                    <input type="text" id="nombre" name="nombre" data-validate="true" class="form-control" placeholder="Ingresa el título..." value="">
			                </div>
			                <div class="input-group espacios">
			                ...
			                <div class="input-group espacios">
			                    <span class="input-group-addon">Link del video de Youtube / Vimeo</span>
			                    <textarea name="comentario" id="comentario" rows="6" class="form-control" placeholder="Ejemplo:https://www.youtube.com/watch?v=cRJVePHJnP8" data-validate="false"></textarea>
			                </div>
	...
	<footer id="footer">
		...
		<script src="js/functionsTestimonio3.js"></script>
	</footer>
</html>
