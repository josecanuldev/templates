            		...
            		<div class="row rowedit">
                    	...
                    	<form method="post" action="operaciones.php">
                    		...
                    		<div class="styled-large">
		                        ...
		                        ?>
		                                <li>
		                                	<a class="btn btn-warning download espacios" href="clases/reporteExcel.php?tipo=<?=$_tipo?>" style="margin-bottom:10px;"> Descargar Correos <i class="fa fa-download"></i></a>
		                                </li>	                      
		                        <?php
		                    		}
		                    	?>                                      
