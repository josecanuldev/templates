...
$temporal = new consideracion();
//$_pagina = 1, $_paginador = true, $_status = '', $_busqueda = '', $_registrosPorPagina = 20, $_tipo = 1, $_frontEnd = false
$listaTemporal = $temporal -> listConsideracion(1, false);
$clave = 'p_add_consideracion';
$clave2 = 'p_del_consideracion';
$clave3 = 'p_acdc_consideracion';
$clave4 = 'p_sort_consideracion';
$clave5 = 'p_mod_consideracion';
$sort = "consideracion";
$handle = "";
...
$opera_list = 'listarConsideracion';
...
<html lang="es">
	<head>
		...
		<title>Lista | Consideraciones</title>
	</head>
	<body>
		<header>
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                        <p class="titulo">Consideraciones</p>
	                    </div>
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                    	<form action="formConsideracion.php" method="post">
                    		...
                    		<div class="">
		                        ...
		                        <div class="col-md-6 col-xs-12 col-md-pull-6">
		                            <ul class="ulfiltros">
		                                ...
		                                <li class="lifiltros">    
		                                    <button type="submit" class="buttonaplicar" name="operaciones" value="operaconsideracion">Aplicar</button>
		                                </li>	                                
		                            </ul>                     
		                        </div>
		                    </div>
			                    ...
			                    <?php
									foreach($listaTemporal as $elementoTemporal){
										if($seguridad->valida_permiso_usuario($_SESSION['idusuario'],$clave3)==0){
											...
											if($elementoTemporal['status']!=0){
												$img='img/visible.png';
												$funcion='changeStatus('.$elementoTemporal['idConsideracion'].',0,\'changeStatusConsideracion\')';
												$class = 'nover';
											}
											else{
										  		$img='img/invisible.png';
												$funcion='changeStatus('.$elementoTemporal['idConsideracion'].',1,\'changeStatusConsideracion\')';
												$class = 'ver';
										   }
										}
									?>	
											<tr>
				                              	<td>
				                                 	<input type="hidden" name="idorden" class="idorden" value="<?=$elementoTemporal['idConsideracion']?>">
				                                	<input type="checkbox" id="<?=$elementoTemporal['idConsideracion']?>" name="idConsideracion[]" value="<?=$elementoTemporal['idConsideracion']?>">
													<label for="<?=$elementoTemporal['idConsideracion']?>"><span></span></label>
				                                </td>
				                               
				                                <td>
				                                	<div class="edit manita" data-id="<?=$elementoTemporal['idConsideracion']?>" data-titulo="<?=$elementoTemporal['nombre']?>" data-tituloEn="<?=$elementoTemporal['nombreEn']?>">
				                                ...
				                                <td class="text-center">
				                                	...
				                                	<?=$handle?>				                                	
				                                	<img class="manita <?=$class?>" onclick="<?=$funcion?>" id="temp<?=$elementoTemporal['idConsideracion']?>" src="<?=$img?>">
				                                </td>
				                            </tr>    
			                    <?php        
									}
		    		...
		    		<div class="modal-content">
		    			...
		    			<div class="modal-body">
		    				<div class="input-group espacios">
			                    ...
			                    <input type="text" id="titulo" name="titulo" data-validate="true" class="form-control" placeholder="Ingresa el título de la consideración..." value="">
			                </div>
                            <div class="input-group espacios">
			                    <span class="input-group-addon">Título ENG</span>
			                    <input type="text" id="tituloEn" name="tituloEn" data-validate="true" class="form-control" placeholder="Ingresa el título de la consideración..." value="">
			                </div>
		    			</div>
	...
	<footer id="footer">
		...
		<script src="js/functionsConsideracion.js"></script>
	</footer>
</html>