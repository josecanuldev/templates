<?php
	...
	/**
	 * [$temporal: instancia - Clase del atributo]
	 * @var atributo
	 */
	$temporal = new atributo();
	$listaTemporal = $temporal -> listAtributo();
	/**
	 * Variables para los permisos
	 * @var string
	 */
	$clave = 'p_add_atributo';
	$clave2 = 'p_del_atributo';
	$clave3 = 'p_acdc_atributo';
	$clave4 = 'p_sort_atributo';
	$sort = "atributo";
	$handle = "";
	/**
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                        <p class="titulo">Valores Tabla</p>
	                    </div>
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                    	<form action="formAtributo.php" method="post">
                    	...
                    	<form method="post" action="operaciones.php">
                    		...
                    		<div class="styled-large">
		                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		                            <ul class="ulfiltros">
		                                ...
		                                <li class="lifiltros">
		                                    <button type="submit" class="buttonaplicar" name="operaciones" value="operaatributo">Aplicar</button>
		                                </li>
		                            </ul>
		                    ...
		                    <div class="col-lg-12">
		                        ...
		                        <div class="table-responsive">
			                        <table id="tableAtributo" class="table table-hover table-striped tablesorter">
