...
$listaTemporal = $temporal -> listTalla(1, false);
$clave = 'p_add_talla';
$clave2 = 'p_del_tallas';
$clave3 = 'p_acdc_talla';
$clave4 = 'p_sort_talla';
...
<html lang="es">
	<head>
		...
		<title>Lista | Presentaciones</title>
	</head>
	<body>
		<header>
	        ...
	        <div id="page-content-wrapper">
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                    	<form action="formTalla.php" method="post">
                    		...
                    		<div class="">
		                        ...
		                        <div class="col-md-6 col-xs-12 col-md-pull-6">
		                            <ul class="ulfiltros">
		                                ...
		                                <li class="lifiltros">    
		                                    <button type="submit" class="buttonaplicar" name="operaciones" value="operatalla">Aplicar</button>
		                                </li>	                                
		                            </ul>                     
		                        </div>
		                    </div>
			                    ...
			                    <?php
									foreach($listaTemporal as $elementoTemporal){
										if($seguridad->valida_permiso_usuario($_SESSION['idusuario'],$clave3)==0){
											...
											if($elementoTemporal['status']!=0){
												$img='img/visible.png';
												$funcion='changeStatus('.$elementoTemporal['idTalla'].',0,\'changeStatusTalla\')';
												$class = 'nover';
											}
											else{
										  		$img='img/invisible.png';
												$funcion='changeStatus('.$elementoTemporal['idTalla'].',1,\'changeStatusTalla\')';
												$class = 'ver';
										   }
										}
									?>	
											<tr>
				                              	<td>
				                                 	<input type="hidden" name="idorden" class="idorden" value="<?=$elementoTemporal['idTalla']?>">
				                                	<input type="checkbox" id="<?=$elementoTemporal['idTalla']?>" name="idTalla[]" value="<?=$elementoTemporal['idTalla']?>">
													<label for="<?=$elementoTemporal['idTalla']?>"><span></span></label>
				                                </td>
				                               
				                                <td>
				                                	<div class="edit manita" data-id="<?=$elementoTemporal['idTalla']?>" data-titulo="<?=$elementoTemporal['nombre']?>" >
				                                ...
				                                <td class="text-center">
				                                	...
				                                	<?=$handle?>				                                	
				                                	<img class="manita <?=$class?>" onclick="<?=$funcion?>" id="temp<?=$elementoTemporal['idTalla']?>" src="<?=$img?>">
				                                </td>
				                            </tr>    
			                    <?php        
									}
		    		...
		    		<div class="modal-content">
		    			...
		    			<div class="modal-body">
		    				<div class="input-group espacios">
			                    ...
			                    <input type="text" id="titulo" name="titulo" data-validate="true" class="form-control" placeholder="Ingresa el título de la presentación..." value="">
			                </div>
		    			</div>
	...
	<footer id="footer">
		...
		<script src="js/functionsTalla.js"></script>
	</footer>
</html>