...
$temporal = new etiqueta();
$listaTemporal = $temporal -> listEtiqueta(1, false);
$clave = 'p_add_etiqueta';
$clave2 = 'p_del_etiqueta';
$clave3 = 'p_acdc_etiqueta';
$clave4 = 'p_sort_etiqueta';
$clave5 = 'p_mod_etiqueta';
$sort = "etiqueta";
$handle = "";
...
<html lang="es">
	        ...
	        <div id="page-content-wrapper">
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                    	<form action="formEtiqueta.php" method="post">
                    		...
                    		<div class="">
		                        ...
		                        <div class="col-md-6 col-xs-12 col-md-pull-6">
		                            <ul class="ulfiltros">
		                                ...
		                                <li class="lifiltros">    
		                                    <button type="submit" class="buttonaplicar" name="operaciones" value="operaetiqueta">Aplicar</button>
		                                </li>	                                
		                            </ul>                     
		                        </div>
		                    </div>
			                    ...
			                    <?php
									foreach($listaTemporal as $elementoTemporal){
										if($seguridad->valida_permiso_usuario($_SESSION['idusuario'],$clave3)==0){
											...
											if($elementoTemporal['status']!=0){
												$img='img/visible.png';
												$funcion='changeStatus('.$elementoTemporal['idEtiqueta'].',0,\'changeStatusEtiqueta\')';
												$class = 'nover';
											}
											else{
										  		$img='img/invisible.png';
												$funcion='changeStatus('.$elementoTemporal['idEtiqueta'].',1,\'changeStatusEtiqueta\')';
												$class = 'ver';
										   }
										}
									?>	
											<tr>
				                              	<td>
				                                 	<input type="hidden" name="idorden" class="idorden" value="<?=$elementoTemporal['idEtiqueta']?>">
				                                	<input type="checkbox" id="<?=$elementoTemporal['idEtiqueta']?>" name="idEtiqueta[]" value="<?=$elementoTemporal['idEtiqueta']?>">
													<label for="<?=$elementoTemporal['idEtiqueta']?>"><span></span></label>
				                                </td>
				                               
				                                <td>
				                                	<div class="edit manita" data-id="<?=$elementoTemporal['idEtiqueta']?>" data-tituloEs="<?=$elementoTemporal['tituloEs']?>" data-tituloEn="<?=$elementoTemporal['tituloEn']?>">
				                                		<?=$elementoTemporal['tituloEs']?>
				                                	<div>
				                                </td>                   
				                                <td class="text-center">
				                                	<?=$handle?>				                                	
				                                	<img class="manita <?=$class?>" onclick="<?=$funcion?>" id="temp<?=$elementoTemporal['idEtiqueta']?>" src="<?=$img?>">
				                                </td>
				                            </tr>    
			                    <?php        
									}
		    		...
		    		<div class="modal-content">
		    			...
		    			<div class="modal-body">
		    				<div class="input-group espacios">
			                    ...
			                    <input type="text" id="tituloEs" name="tituloEs" data-validate="true" class="form-control" placeholder="Ingresa el titulo de la etiqueta..." value="">
			                </div>
			                <!--<div class="input-group espacios">
			                    <span class="input-group-addon">Titulo EN</span>
			                    <input type="text" id="tituloEn" name="tituloEn" data-validate="true" class="form-control" placeholder="Ingresa el titulo de la etiqueta..." value="">
			                </div>-->
		    			</div>
	...
	<footer id="footer">
		...
		<script src="js/functionsEtiqueta.js"></script>
	</footer>
</html>