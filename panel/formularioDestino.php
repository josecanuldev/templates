...
<html lang="es">
	<head>
		...
		<title>Formulario | Destinos</title>
	</head>
	<body>
		<header>
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <form id="form-validation" style="display: inline" name="form1" action="operaciones.php" method="post" enctype="multipart/form-data">
                    		...
                    		<input type="hidden" name="seccion" value="Destino">
		                    ...
		                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		                    	<div role="tabpanel">
		                    		...
		                    		<ul class="nav nav-tabs" role="tablist">
		                    			...
		                    			<li role="presentation">
		                    				<a href="listaTestimonio.php?idDestino=<?=$id?>">Características</a>
		                    			</li>
                                        <li role="presentation">
		                    		...
		                    		<div class="tab-content">
														...
														<div class="panel-body">
															<center class="espacios">
																...
																<div id="preview-portada" class="espacios">
																	...
																	<img src="../img/imgDestino/<?=$temporal -> imgPortada?>" alt="" class="img-responsive">
																	<?php } else { ?>
																...
																<p class="help-block"><small>Solo se aceptan imagenes con formato .JPG, .JPEG, .PNG; La imagen debe ser menor a 2 MB. <br> La resolución óptima para esta imagen es de 362 X 362 </small></p>
															</center>
														</div>
													</div> <!-- /panel -->
							                    </div>
							                    			...
							                    			<div class="row">
							                    				...
							                    				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
											                        <div class="input-group espacios">
											                        	...
											                        	<input type="text" name="inicial" data-validate="false" class="form-control" placeholder="Ejemplo: https://www.youtube.com/watch?v=D8Ert5yjMV4" value="<?=$temporal -> datos -> inicial?>">
											                        </div>
											                        <div class="input-group espacios" style="display:none">
											                        	<span class="input-group-addon">Tags</span>
											                        	<input type="text" name="concepto_inicial" data-validate="false" class="form-control" placeholder="Ingresa los tags" value="<?=$temporal -> datos -> concepto?>">
											                        </div>
                                                                    <div class="input-group espacios" style="display:none">
											                        	<span class="input-group-addon">Tags en inglés</span>
											                        	<input type="text" name="capacidad1" data-validate="false" class="form-control" placeholder="Ingresa los tags en inglés" value="<?=$temporal -> datos -> capacidad1?>">
											                        </div>
											                    </div>
											                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="display:none">
											                        <div class="input-group espacios">
											                        	<span class="input-group-addon">Capacidad gral.</span>
											                        	<input type="number" name="capacidad2" maxlength="2" data-validate="false" class="form-control" placeholder="Ingresa la capacidad máxima general" value="<?=$temporal -> datos -> capacidad2?>">
											                        </div>
											                    </div>
											                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											                        <div class="input-group espacios">
                                                                     ...
                                                                     <div class="input-group espacios">
											                        	...
											                        	<textarea name="descripcionEn" id="descripcionEn" rows="8" class="form-control" placeholder="Ingresa la descripción en inglés" data-summer="true" data-validate="true"><?=$temporal -> datos -> descripcionEn?></textarea>
											                        </div>
											                    </div>
											                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="display:none">
											                        <div class="input-group espacios">
											                        	<span class="input-group-addon">Recomendaciones</span>
											                        	<textarea name="politicas" id="politicas" rows="8" class="form-control" placeholder="Ingresa las recomendaciones" data-politix="true" data-validate="false"><?=$temporal -> datos -> politicas?></textarea>
											                        </div>
                                                                    <div class="input-group espacios">
											                        	<span class="input-group-addon">Recomendaciones en inglés</span>
											                        	<textarea name="politicasEn" id="politicasEn" rows="8" class="form-control" placeholder="Ingresa las recomendaciones en inglés" data-politix="true" data-validate="false"><?=$temporal -> datos -> politicasEn?></textarea>
											                        </div>
											                    </div>
							                    			</div>
							                    		</div>
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="galeria">
		                    				<div class="row">
												...
												<div class="col-lg-12 col-md-4 col-xs-12">
													<center class="espacios">
		                    							...
		                    							<p class="help-block text-center"><small>Solo se aceptan imagenes con formato .JPG, .JPEG, .PNG; La imagen debe ser menor a 3 MB. <br> La resolución óptima para esta imagen es de 362 X 362 </small></p>
		                    							<br>
													</center>
												</div>
		                    				</div>
		                    				<div class="row" id="sortableImg">
							                    <?php 
							                    $galeria = $temporal -> listaGaleria('en', 'Destino');
							                    		...
							                    		<div class="panel-body">
							                    			...
							                    			<center class="espacios">
																<div id="preview-slide-<?=$slide['idGaleria']?>" class="espacios">
																	<img src="../img/imgDestino/galeria/<?=$slide['ruta']?>" alt="" class="img-responsive">
																</div>
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="resenias">
		                    				<br>
		                    				<div class="row" id="preview-resenias">
		                    					<?php 
		                    					$resenias = $temporal -> listaResenia('en', 'Destino'); 
		                    					if (count($resenias) > 0) { 
		                    								...
		                    								<div class="row">
		                    									<div class="col-md-6">
		                    										...
		                    										<div class="input-group espacios">
											                        	...
											                        	<input type="text" name="resenia[nombre][]" data-validate="false" class="form-control" placeholder="Ingresa el nombre" value="<?=$resenia['nombre']?>">
											                        </div>
		                    									</div>
		                    									<div class="col-md-6">
		                    										<div class="input-group espacios">
											                        	<span class="input-group-addon">Estrellas</span>
											                        	<input type="number" min="0" max="5" class="form-control" placeholder="Ingresa el número" name="resenia[fecha][]" value="<?=$resenia['fecha']?>">
											                        </div>
		                    									</div>
		                    									<div class="col-md-12">
		                    										<div class="input-group espacios">
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="info">
		                    				<br>
		                    				<?php $temporal -> obtenerTarifa('en', 'Destino'); ?>
		                    				<div class="row">
						                    					...
						                    					<div class="col-md-12 col-sm-12">
						                    						<div class="form-group">
							                    						<div class="input-group">
							                    							...
							                    							<input type="text" name="precios[periodo1][]" data-validate="false" class="form-control" placeholder="Día" value="<?=$precio['precio1']?>">
												                        </div>
												                    </div>
						                    					</div>
																<div class="col-md-12 col-sm-12">
						                    						...
						                    						<div class="form-group">
					            										<div class="input-group">
												                        	...
												                        	<input type="text" name="precios[concepto][]" data-validate="false" class="form-control" placeholder="Actividad" value="<?=$precio['concepto']?>">
												                        </div>
												                    </div>
						                    					</div>
                                                                <div class="col-md-12 col-sm-12">
						                    						<div class="form-group">
					            										<div class="input-group">
												                        	...
												                        	<input type="text" name="precios[conceptoEn][]" data-validate="false" class="form-control" placeholder="Actividad inglés" value="<?=$precio['conceptoEn']?>">
												                        </div>
												                    </div>
						                    					</div>
						                    					<!-- <div class="col-md-6 col-sm-12">
