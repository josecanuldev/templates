...
$_tipo = $_REQUEST['tipo'];
if($_tipo == 'usuario'){
	$_titulo = 'Newsletter Blog';
}else{
	$_titulo = 'Newsletter Blog';
}
$temporal = new newsletterblog();
$listaTemporal = $temporal -> listNewsletter(1, true,'', '', 50, false, $_tipo);
...
$opera_list = 'listarNewsletterBlog';
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
                    	...
                    	<form method="post" action="operaciones.php">
                    		...
                    		<input type="hidden" id="tipo-newsletter" value="<?=$_tipo?>">
                    		<div class="styled-large">
		                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		                            <ul class="ulfiltros">
		                                ...
		                                <li class="lifiltros">
		                                    <button type="submit" class="buttonaplicar" name="operaciones" value="operanewsletterblog">Aplicar</button>
		                                </li>
		                        <?php
		                            if($seguridad->valida_permiso_usuario($_SESSION['idusuario'],$clave5) != 0){
		                        ?>
		                                <li>
		                                	<a class="btn btn-warning download espacios" href="clases/reporteExcelBlog.php?tipo=<?=$_tipo?>" style="margin-bottom:10px;"> Descargar Correos <i class="fa fa-download"></i></a>
		                                </li>
		                        <?php
		                    		}
		                    	?>
