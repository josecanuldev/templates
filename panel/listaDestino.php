...
$listaTemporal = $temporal -> listaExperiencia(1, true, '', 'Destino');
// print_r($listaTemporal);
// exit;

$clave  = 'p_add_destino';
$clave2 = 'p_del_destino';
$clave3 = 'p_acdc_destino';
$clave4 = 'p_sort_destino';
$clave5 = 'p_mod_destino';
$sort   = "experiencia";
$handle = "";
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
                    	...
                    	<form method="post" action="operaciones.php">
                    		...
                    		<input type="hidden" id="filtroTipo" name="tipo" value="Destino">
                    		<div class="">
			                        ...
			                        <table id="table-short" class="table table-hover table-striped tablesorter">
					                    ...
					                    <?php
											...
											<tr>
                                                ...
                                                <td>
				                                	<a href="formularioDestino.php?id=<?=$elementoTemporal['idExperiencia']?>">
				                                		<img src="../img/imgDestino/<?=$elementoTemporal['imgPortada']?>" class="img-responsive">
				                                	</a>
				                                </td>
				                                <td>
				                                	<a href="formularioDestino.php?id=<?=$elementoTemporal['idExperiencia']?>">
