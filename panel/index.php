...
<body>
	...
	<header>
    	...
    	<div class="styled-large">
            <!-- <div id="navBlack" class="jumbotron navbar-fixed-top">
                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-3">
                    ...
                    <spam id="urlLocker"><?=NAME?></spam>
                </div>
                <div class="col-lg-8 col-md-8 col-sm-9 col-xs-9">
                    <p id="fecha"><?php echo date('d')." ".$meses[date('n')-1]. " ".date('Y') ;?></p>
                </div>
            </div> -->
            <div id="navBlue" class="jumbotron navbar-fixed-top" style="top: 0px !important">
                ...
                <div class="col-lg-9 col-md-8">
                    <p class="urlweb">Bienvenido al panel de control <?=NAME?></p>
                </div>
                <div class="col-lg-2 col-md-2 text-right">
                    <p id="fecha" style="margin: 17px 40px 0 0 !important;"><?php echo date('d')." ".$meses[date('n')-1]. " ".date('Y') ;?></p>
                </div>
            </div>
        </div>
        ...
        <div class="styled-small">
            ...
            <div id="navBlueMovil" class="jumbotron navbar-fixed-top" style="top: 0px !important">
            	<p id="panel">PANEL DE CONTROL</p>
            </div>
            <div id="navBlueMovil2" class="jumbotron navbar-fixed-top" style="top: 42px !important">
            	 <p class="urlweb">Bienvenido al panel de control <?=NAME?></p>
            </div>
        </div>
    </header>
