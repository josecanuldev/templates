                        ...
                        <form id="form-validation" action="operaciones.php" method="post" name="form1" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                                ...
                                <div id="msgidAnalitics" class="input-group espacios">
                                    <span class="input-group-addon es">
                                        <i class="fa fa-server"></i>ID Analytics
                                        <a href="https://support.google.com/analytics/answer/9539598?hl=es" target="_blank">
                                ...
                                <div id="msgConversionGoogle" class="input-group espacios">
                                    <span class="input-group-addon es">
                                        <i class="fa fa-server"></i>Google Maps (iframe)
                                        <a href="https://www.dongee.com/tutoriales/como-poner-google-maps-en-mi-pagina-web/" target="_blank">
                                            <i class="fa fa-question"></i>
                                        </a>
                                    </span>
