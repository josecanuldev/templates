...
if (isset($_REQUEST['id'])) {
	$id        = $_REQUEST['id'];
	$palabra   = 'Editar servicio estándar hasta Chiquilá';
	$temporal  = new experiencia($id);
	$temporal -> obtenerExperiencia();
} else {
	$id        = 0;
	$operacion = 'agregarexperiencia';
	$palabra   = 'Nuevo servicio estándar hasta Chiquilá';
	$_MOD      = '0';
	$clave     = 'p_add_precios';
	$img       = '';
	$temporal  = new experiencia($id);
...
<html lang="es">
	<head>
		...
		<title>Formulario | servicio estándar hasta Chiquilá</title>
	</head>
	<body>
		<header>
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <form id="form-validation" style="display: inline" name="form1" action="operaciones.php" method="post" enctype="multipart/form-data">
                    		...
                    		<input type="hidden" name="seccion" value="ServicioEstandar">
		                    		...
		                    		<div class="tab-content">
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="galeria">
		                    				...
		                    				<div class="row" id="sortableImg">
							                    <?php
							                    $galeria = $temporal -> listaGaleria('en', 'ServicioEstandar');
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="caracteristicas">
		                    				...
		                    				<div class="row" id="preview-resenias">
		                    					<?php
		                    					$resenias = $temporal -> listaResenia('en', 'ServicioEstandar');
		                    					if (count($resenias) > 0) {
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="info">
		                    				<br>
		                    				<?php $temporal -> obtenerTarifa('en', 'ServicioEstandar'); ?>
		                    				<div class="row">
