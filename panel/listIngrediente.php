...
$temporal = new ingrediente();
//$_pagina = 1, $_paginador = true, $_status = '', $_busqueda = '', $_registrosPorPagina = 20, $_tipo = 1, $_frontEnd = false
$listaTemporal = $temporal -> listIngrediente(1, false);
$clave = 'p_add_ingrediente';
$clave2 = 'p_del_ingrediente';
$clave3 = 'p_acdc_ingrediente';
$clave4 = 'p_sort_ingrediente';
$clave5 = 'p_mod_ingrediente';
$sort = "ingrediente";
$handle = "";
...
<html lang="es">
                    		...
                    		<div class="">
		                        ...
		                        <div class="col-md-6 col-xs-12 col-md-pull-6">
		                            <ul class="ulfiltros">
		                                ...
		                                <li class="lifiltros">    
		                                    <button type="submit" class="buttonaplicar" name="operaciones" value="operaingrediente">Aplicar</button>
		                                </li>	                                
		                            </ul>                     
		                        </div>
		                    </div>
			                    ...
			                    <?php
									foreach($listaTemporal as $elementoTemporal){
										if($seguridad->valida_permiso_usuario($_SESSION['idusuario'],$clave3)==0){
											...
											if($elementoTemporal['status']!=0){
												$img='img/visible.png';
												$funcion='changeStatus('.$elementoTemporal['idIngrediente'].',0,\'changeStatusIngrediente\')';
												$class = 'nover';
											}
											else{
										  		$img='img/invisible.png';
												$funcion='changeStatus('.$elementoTemporal['idIngrediente'].',1,\'changeStatusIngrediente\')';
												$class = 'ver';
										   }
										}
									?>	
											<tr>
				                              	<td>
				                                 	<input type="hidden" name="idorden" class="idorden" value="<?=$elementoTemporal['idIngrediente']?>">
				                                	<input type="checkbox" id="<?=$elementoTemporal['idIngrediente']?>" name="idIngrediente[]" value="<?=$elementoTemporal['idIngrediente']?>">
													<label for="<?=$elementoTemporal['idIngrediente']?>"><span></span></label>
				                                </td>
				                               
				                                <td>
				                                	<div class="edit manita" data-id="<?=$elementoTemporal['idIngrediente']?>" data-titulo="<?=$elementoTemporal['nombre']?>" data-tituloEn="<?=$elementoTemporal['nombreEn']?>">
				                                ...
				                                <td class="text-center">
				                                	...
				                                	<?=$handle?>				                                	
				                                	<img class="manita <?=$class?>" onclick="<?=$funcion?>" id="temp<?=$elementoTemporal['idIngrediente']?>" src="<?=$img?>">
				                                </td>
				                            </tr>    
			                    <?php        
									}
		    		...
		    		<div class="modal-content">
		    			...
		    			<div class="modal-body">
		    				<div class="input-group espacios">
			                    ...
			                    <input type="text" id="titulo" name="titulo" data-validate="true" class="form-control" placeholder="Ingresa el título del ingrediente..." value="">
			                </div>
                            <div class="input-group espacios">
			                    <span class="input-group-addon">Título ENG</span>
			                    <input type="text" id="tituloEn" name="tituloEn" data-validate="false" class="form-control" placeholder="Ingresa el título del ingrediente en inglés..." value="">
			                </div>
		    			</div>
	...
	<footer id="footer">
		...
		<script src="js/functionsIngrediente.js"></script>
	</footer>
</html>