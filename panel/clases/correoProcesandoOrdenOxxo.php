...
class correoProcesandoOrdenOxxo extends correo
{
    var $path  = "http://";

    function correoProcesandoOrdenOxxo($idorden,$barcode,$imagen)
    {
        $this->correo();
                                ...
                                <table class="table" style="width:100%">
                                    <tr>
                                        ...
                                        <td style="padding:25px;">
                                            ...
                                            <br>
                                            <font face="Roboto" style="text-align:center">
                                                <!--<img src="'.$this -> path.'img/pagooxxo.png">-->
                                                <p><img src="'.$this -> imagen.'" /></p>
                                                <p style="font-weight:300">'.$this -> barcode.'</p>
                                            </font><br><br>
                                            <p style="font-size: 15px; font-weight:100; font-family:\'Roboto\'">Mostrar este código a la tienda Oxxo.</p>
                                        </td>
                                        <td width="10" style="padding:7px 0">&nbsp;</td>
                                    </tr>
                                </table>
