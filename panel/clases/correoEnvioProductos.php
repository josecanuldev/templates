...
class correoEnvioProductos extends correo
{
    ...
    {
        $this->correo->Subject='La Anita Orden Enviada';
    }
                        ...
                        <!--<tr>
                            <td align="left" class="titleblock" style="padding:7px 0">
                                <font size="2" face="Palatino" color="#b7985b">
                                    <span class="subtitle" style="font-size:33px;line-height:33px">Nuevo mensaje de La Anita.</span>
                                </font>
                            </td>
                        </tr>   -->
                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding:25px;">
                                            <font size="2" color="#000">
                                                <span class="subtitle" style="font-size:33px;line-height:33px; font-weight:700">Tu compra ha sido enviada.</span>
                                            </font><br /><br />
                                            <font size="2" face="Roboto" color="#000000">
                                                <p style="font-size: 15px; font-weight:100; font-family:\'Roboto\'">
                                                    ...
                                                    ¡Gracias por comprar con nosotros! Su pedido ha sido enviado y debe llegar pronto. <br> <br>
                                                    Estos son los detalles de su pedido. <br> <br>
                                                    <strong>Información y dirección de envío:</strong><br>
                                                    <strong>Nombre: </strong>'.$datosOrden -> nombreCliente.' <br>
                                                    <strong>Dirección: </strong>'.$datosOrden -> direccionCliente.'<br>
                                                    <strong>Estado y Ciudad: </strong>'.$datosOrden -> ciudadCliente.', '.$datosOrden -> estadoCliente.', C.P. '.$datosOrden -> cpCliente.'<br><br>
                                                    <strong>Teléfono: </strong>'.$datosOrden -> telefonoCliente.' <br>
                                                    <strong>E-mail: </strong>'.$datosOrden -> emailCliente.' <br><br>
                                                    <strong>Orden: </strong><span>'.$datosOrden -> idOrden.'</span><br><br>
                                                </p>
                                            </font>
