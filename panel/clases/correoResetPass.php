...
class correoResetPass extends correo
{
    var $path  = "http://";
    var $_correo;
    var $_cliente;

    function correoResetPass($_correo = '')
    {
        $this -> correo();
        $this -> _correo = $_correo;
        $this -> _cliente = new cliente();
        $this -> _cliente -> getToken($_correo);
    }

    function genera_asunto()
    {
        $this -> correo -> Subject = 'Recuperación Contraseña La Anita';
    }

    function genera_destino()
    {
        $this -> correo -> AddAddress($this -> _correo);
    }
                        ...
                        <!--<tr>
                            <td align="left" class="titleblock" style="padding:7px 0">
                                <font size="2" color="#b7985b">
                                    <span class="subtitle" style="font-size:33px;line-height:33px;font-weight:700">Recuperar contraseña.</span>
                                </font>
                            </td>
                        </tr>   -->
                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding:25px;">
                                            <font size="2" face="Palatino" color="#000">
                                                <span class="subtitle" style="font-size:33px;line-height:33px">¡Hola!</span>
                                            </font><br /><br />
                                            <font size="2" face="Roboto" color="#000000">
                                                <p style="font-size: 15px; font-weight:100; font-family:\'Roboto\'">
                                                    Recibiste este correo electrónico porque has olvidado tu contraseña y quieres restablecerla. Simplemente siga el enlace que aparece a continuación para iniciar el proceso.
                                                    Si no solicitó restablecer su contraseña o recibió este correo electrónico por error, por favor, ignórelo.
                                                    <a href="'.$this -> path.'secure/resetPassword-'.$this -> _cliente -> token.'" title="">RECUPERAR MI CONTRASEÑA</a>
                                                </p>
                                            </font>
                                        </td>
                                        <td width="10" style="padding:7px 0">&nbsp;</td>
