<?php
    ...
    if (PHP_SAPI == 'cli')
        ...
        $objPHPExcel->getProperties()->setCreator("Grupo Logra") //Autor
                             ->setLastModifiedBy("Grupo Logra") //Ultimo usuario que lo modificó
                             ->setTitle("Newsletter")
                             ->setSubject("Grupo Logra")
                             ->setDescription("Newsletter")
                             ->setKeywords("Newsletter")
                             ->setCategory("Reporte excel");

        $tituloReporte = "Newsletter Grupo Logra";
