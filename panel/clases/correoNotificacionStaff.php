...
1: Nuevo Usuario.
2: Han subido una nuevo diseño.
3: Han realizado una compra.
 */

class correoNotificacionStaff extends correo
{
    var $tipo;
    var $path  = "https://cancuntoislamujeres.com/";

    function correoNotificacionStaff($idorden=0)
    {
        $this->correo();
    ...
    {
        $this -> correo -> Subject = "Nueva reserva en sitio web Cancun To Isla Mujeres";
    }

    function genera_destino()
    {
        $this->correo->AddAddress('admin@cancuntoislamujeres.com');
    }
    ...
    function genera_mensaje()
    {
      ...
      if($reserva->idExperiencia==91 && $reserva->tipoViaje=='Redondo'){
        $horaPrivada='Hora de salida del vuelo';
      } elseif($reserva->idExperiencia==102 && $reserva->tipoViaje=='Redondo'){
        $horaPrivada='Hora de salida del vuelo';
      } elseif($reserva->idExperiencia==91 && $reserva->inverso=="true"){
        $horaPrivada='Hora de salida del vuelo';
      } elseif($reserva->idExperiencia==102 && $reserva->inverso=="true"){
        $horaPrivada='Hora de salida del vuelo';
      } else{
                    ...
                    <td style="padding:7px 0">
                      <font size="2" face="Open-sans, sans-serif" color="#555454">
                        <p data-html-only="1" style="border-bottom:1px solid #D6D4D4;margin:3px 0 7px;font-weight:500;font-size:14px;padding-bottom:10px">Folio ('.$prefixPrivado.'-'.$folio.') - Detalles de la reservación
                          ...
                          <span style="color:#333"><strong>Fecha de reservación</strong></span> '.$reserva->fechaReservacion.' <br /><br />
                          <span style="color:#333"><strong>Pasajeros</strong></span> '.$reserva->pasajeros.' <br />
                          <span style="color:#333"><strong>Tipo de viaje</strong></span> '.$reserva->tipoViaje.' <br /><br />
                          ...
                          <span style="color:#333"><strong>Ciudad</strong></span> '.$reserva->ciudad.' <br /><br />
                          ...
                          <span style="color:#333;'.$oculto10.'"><strong>Tipo de vuelo</strong></span> '.$reserva->tipoVuelo.' <br style="'.$oculto10.'" /><br />
