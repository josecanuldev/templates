<?php
	...
	/**
	 * [$temporal: instancia - Clase del marca]
	 * @var marca
	 */
	$temporal = new marca();
	$listaTemporal = $temporal -> listMarca();
	/**
	        ...
	        <div id="page-content-wrapper">
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                    	<form action="formMarca.php" method="post">
                    	...
                    	<form method="post" action="operaciones.php">
                    		...
                    		<div class="styled-large">
		                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		                            <ul class="ulfiltros">
		                                ...
		                                <li class="lifiltros">
		                                    <button type="submit" class="buttonaplicar" name="operaciones" value="operamarca">Aplicar</button>
		                                </li>
		                            </ul>
		                    ...
		                    <div class="col-lg-12">
		                        ...
		                        <div class="table-responsive">
			                        <table id="tableMarca" class="table table-hover table-striped tablesorter">
