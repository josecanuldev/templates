...
$listaTemporal = $temporal -> listaExperiencia(1, true, '', 'ServicioEstandar');
...
<html lang="es">
	<head>
		...
		<title>Lista | servicio estándar hasta Chiquilá</title>
	</head>
	<body>
		<header>
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                        <p class="titulo">Precios servicio estándar hasta Chiquilá</p>
	                    </div>
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                    	<form action="formularioServicioEstandar.php" method="post">
                    	...
                    	<form method="post" action="operaciones.php">
                    		...
                    		<input type="hidden" id="filtroTipo" name="tipo" value="ServicioEstandar">
                    		<div class="">
			                        ...
			                        <table id="table-short" class="table table-hover table-striped tablesorter">
					                    ...
					                    <?php
											...
											<tr>
				                                ...
				                                <td>
				                                	<a href="formularioServicioEstandar.php?id=<?=$elementoTemporal['idExperiencia']?>">
