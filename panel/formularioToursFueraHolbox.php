...
<html lang="es">
	<head>
		...
		<title>Formulario | Tour fuera de Holbox </title>
	</head>
	<body>
		<header>
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <form id="form-validation" style="display: inline" name="form1" action="operaciones.php" method="post" enctype="multipart/form-data">
                    		...
                    		<input type="hidden" name="seccion" value="ToursFueraHolbox">
		                    		...
		                    		<div class="tab-content">
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="galeria">
		                    				...
		                    				<div class="row" id="sortableImg">
							                    <?php
							                    $galeria = $temporal -> listaGaleria('en', 'ToursFueraHolbox');
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="caracteristicas">
		                    				...
		                    				<div class="row" id="preview-resenias">
		                    					<?php
		                    					$resenias = $temporal -> listaResenia('en', 'ToursFueraHolbox');
		                    					if (count($resenias) > 0) {
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="info">
		                    				<br>
		                    				<?php $temporal -> obtenerTarifa('en', 'ToursFueraHolbox'); ?>
		                    				<div class="row">
				                    					...
				                    					<div class="panel-body">
				                    						<div class="row">
                                                                ...
                                                                <div class="col-md-12 col-sm-12">
						                    						<div class="form-group">
							                    						<div class="input-group">
							                    							<span class="input-group-addon">Día inglés</span>
							                    							<input type="text" name="precios[horaEn][]" data-validate="false" class="form-control" placeholder="Día inglés" value="<?=$precio['horaEn']?>">
												                        </div>
												                    </div>
						                    					</div>
																<div class="col-md-12 col-sm-12">
