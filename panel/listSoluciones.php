...
$clave = 'p_add_solucion';
$clave2 = 'p_del_solucion';
$clave3 = 'p_acdc_solucion';
$clave4 = 'p_sort_solucion';
$sort = "blog";
$handle = "";
	        ...
	        <div id="page-content-wrapper">
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                    	<form action="formSoluciones.php" method="post">
	                    		<input class="hidden" name="tipo" value="<?=$tipo?>"></input>
			                    ...
			                    <?php
									...
									?>
											<tr>
				                                ...
				                                <td>
				                                	<a href="formSoluciones.php?idBlog=<?=$elementoTemporal['idBlog']?>&tipo=<?=$tipo?>"><img class="img-responsive" src="../img/imgBlog/<?=$elementoTemporal['portada']?>"></a>
				                                </td>
				                                <td>
				                                	<a href="formSoluciones.php?idBlog=<?=$elementoTemporal['idBlog']?>&tipo=<?=$tipo?>">
