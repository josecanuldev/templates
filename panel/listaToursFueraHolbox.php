...
$listaTemporal = $temporal -> listaExperiencia(1, true, '', 'ToursFueraHolbox');
// print_r($listaTemporal);
// exit;

$clave  = 'p_add_circuito';
$clave2 = 'p_del_circuito';
$clave3 = 'p_acdc_circuito';
$clave4 = 'p_sort_circuito';
$clave5 = 'p_mod_circuito';
$sort   = "experiencia";
$handle = "";
...
<html lang="es">
	<head>
		...
		<title>Lista | Tours fuera de Holbox</title>
	</head>
	<body>
		<header>
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                        <p class="titulo">Tours fuera de Holbox</p>
	                    </div>
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                    	<form action="formularioToursFueraHolbox.php" method="post">
                    	...
                    	<form method="post" action="operaciones.php">
                    		...
                    		<input type="hidden" id="filtroTipo" name="tipo" value="ToursFueraHolbox">
                    		<div class="">
					                    ...
					                    <?php
											...
											<tr>
				                              	<td>
				                               	...
				                               	<td>
				                                	<a href="formularioToursFueraHolbox.php?id=<?=$elementoTemporal['idExperiencia']?>">
				                                		<img src="../img/imgToursFueraHolbox/<?=$elementoTemporal['imgPortada']?>" class="img-responsive">
				                                	</a>
				                                </td>
				                                <td>
				                                	<a href="formularioToursFueraHolbox.php?id=<?=$elementoTemporal['idExperiencia']?>">
