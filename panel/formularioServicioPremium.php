...
if (isset($_REQUEST['id'])) {
	$id        = $_REQUEST['id'];
	$palabra   = 'Editar servicio premium puerta puerta hasta Isla Holbox';
	$temporal  = new experiencia($id);
	$temporal -> obtenerExperiencia();
} else {
	$id        = 0;
	$operacion = 'agregarexperiencia';
	$palabra   = 'Nuevo servicio premium puerta puerta hasta Isla Holbox';
	$_MOD      = '0';
	$clave     = 'p_add_precios';
	$img       = '';
	$temporal  = new experiencia($id);
...
<html lang="es">
	<head>
		...
		<title>Formulario | servicio premium puerta puerta hasta Isla Holbox</title>
	</head>
	<body>
		<header>
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <form id="form-validation" style="display: inline" name="form1" action="operaciones.php" method="post" enctype="multipart/form-data">
                    		...
                    		<input type="hidden" name="seccion" value="ServicioPremium">
		                    ...
		                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		                    	<div role="tabpanel">
		                    		...
		                    		<ul class="nav nav-tabs" role="tablist">
		                    			...
		                    			<li role="presentation">
		                    				<a href="#caracteristicas" aria-controls="resenias" role="tab" data-toggle="tab">Características</a>
		                    			</li>-->
		                    			<li role="presentation">
		                    		...
		                    		<div class="tab-content">
														...
														<div class="panel-body">
															<center class="espacios">
																...
																<div id="preview-portada" class="espacios">
																	...
																	<img src="../img/imgToursFueraHolbox/<?=$temporal -> imgPortada?>" alt="" class="img-responsive">
																	<?php } else { ?>
																	<div style="background-color: #ddd; display: block; min-height: 180px; width: 100%;"></div>
																	<?php } ?>
																</div>
																<input type="file" onChange="showMyImage('preview-portada', this)" name="portada" id="portada" class="filestyle" data-input="false" data-buttonText="Imagen Principal" data-iconName="fa fa-picture-o" data-badge="false" data-type-file="imagen" data-validate="false" data-text="Imagen Principal">
							                    			...
							                    			<div class="row">
							                    				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							                    					<div class="input-group espacios">
											                        	...
											                        	<input type="text" name="nombre" data-validate="true" class="form-control" placeholder="Ingresa punto de partida" value="<?=$temporal -> datos -> nombre?>">
											                        </div>
							                    				</div>
                                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							                    					<div class="input-group espacios">
											                        	<span class="input-group-addon">Desde en inglés</span>
											                        	<input type="text" name="nombreEn" data-validate="false" class="form-control" placeholder="Ingresa punto de partida en inglés" value="<?=$temporal -> datos -> nombreEn?>">
											                        </div>
							                    				</div>
											                    ...
											                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											                        <div class="input-group espacios">
											                        	...
											                        	<textarea name="descripcion" id="descripcion" rows="8" class="form-control" placeholder="Ingresa la descripción" data-summer="true" data-validate="false"><?=$temporal -> datos -> descripcion?></textarea>
											                        </div>
                                                                     <div class="input-group espacios">
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="galeria">
		                    				...
		                    				<div class="row" id="sortableImg">
							                    <?php
							                    $galeria = $temporal -> listaGaleria('en', 'ServicioPremium');
							                    		...
							                    		<div class="panel-body">
							                    			...
							                    			<center class="espacios">
																<div id="preview-slide-<?=$slide['idGaleria']?>" class="espacios">
																	<img src="../img/imgToursFueraHolbox/galeria/<?=$slide['ruta']?>" alt="" class="img-responsive">
																</div>
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="caracteristicas">
		                    				...
		                    				<div class="row" id="preview-resenias">
		                    					<?php
		                    					$resenias = $temporal -> listaResenia('en', 'ServicioPremium');
		                    					if (count($resenias) > 0) {
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="info">
		                    				<br>
		                    				<?php $temporal -> obtenerTarifa('en', 'ServicioPremium'); ?>
		                    				<div class="row">
		                    			...
		                    			<div role="tabpanel" class="tab-pane" id="tarifas">
		                    				...
		                    				<div class="row" id="preview-range">
		                    					...
		                    					<div class="col-md-6 col-sm-12" id="tarifa-<?=$precio['idTarifaDatos']?>">
				                    				<div class="panel panel-default">
				                    					<div class="panel-heading">
				                    						...
				                    						<h3 class="panel-title">Tarifas</h3>
				                    					</div>
				                    					<div class="panel-body">
				                    						<div class="row">
						                    					<div class="col-md-12 col-sm-12">
						                    						<div class="form-group">
							                    						<div class="input-group">
							                    							...
							                    							<input type="text" name="precios[periodo1][]" data-validate="false" class="form-control" placeholder="Pasajeros" value="<?=$precio['precio1']?>">
												                        </div>
												                    </div>
						                    					</div>
                                                                <div class="col-md-12 col-sm-12">
                                                ...
                                                <select name="precios[horaEn][]" class="form-control">
                                                  <?php
                      	                        		 $tipo1 = '';
                                  									 $tipo2 = '';

                                  									 if($precio['horaEn'] == "Sencillo")
                                  									 	$tipo1 = ' selected';
                                  									 if ($precio['horaEn'] =="Redondo")
                                  									 	$tipo2 = ' selected';

                      	                        		?>
                                                  <option value="Sencillo" <?=$tipo1?>>Sencillo</option>
                                                  <option value="Redondo" <?=$tipo2?>>Redondo</option>
                                                </select>
												                        </div>
												                    </div>
						                    					</div>
																<div class="col-md-12 col-sm-12">
						                    						...
						                    						<div class="form-group">
					            										<div class="input-group">
												                        	...
												                        	<input type="number" name="precios[concepto][]" data-validate="true" class="form-control" placeholder="Precio MXN" value="<?=$precio['concepto']?>">
												                        </div>
												                    </div>
						                    					</div>
                                                                <div class="col-md-12 col-sm-12">
						                    						<div class="form-group">
					            										<div class="input-group">
												                        	...
												                        	<input type="number" name="precios[conceptoEn][]" data-validate="true" class="form-control" placeholder="Precio USD"  value="<?=$precio['conceptoEn']?>">
												                        </div>
												                    </div>
						                    					</div>
						                    					<!-- <div class="col-md-6 col-sm-12">
