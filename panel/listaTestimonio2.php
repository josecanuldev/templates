...
$listaTemporal = $temporal -> listaTestimonio(1, false, '', $_REQUEST['idDestino']);
// print_r($listaTemporal);
// exit;

$clave  = 'p_add_testimonio2';
$clave2 = 'p_del_testimonio2';
$clave3 = 'p_acdc_testimonio2';
$clave4 = 'p_sort_testimonio2';
$clave5 = 'p_mod_testimonio2';
$sort   = "testimonio2";
$handle = "";
...
<html lang="es">
            		...
            		<div class="row rowedit">
	                    ...
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                    	<form action="formularioTestimonioInicio.php" method="post">
                                ...
                                <a href="formSoluciones.php?idBlog=<?=$_REQUEST['idDestino']?>&tipo=2"><button type="button" class="buttonagregar2" style="margin-right:15px">Regresar</button></a>
	                        </form>
	                    </div>
	                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                    	<hr class="hrmenu">
                    		...
                    		<div class="">
		                        ...
		                        <div class="col-md-6 col-xs-12 col-md-pull-6">
		                            <ul class="ulfiltros">
		                                ...
		                                <li class="lifiltros">
		                                    <button type="submit" class="buttonaplicar" name="operaciones" value="operatestimonio2">Aplicar</button>
		                                </li>
		                            </ul>
		                        </div>
		                    </div>
		    		...
		    		<div class="modal-content">
		    			...
		    			<div class="modal-body">
		    				<center class="espacios">
								...
								<input type="file" onchange="showMyImage('preview-testimonio', this)" name="imagen" id="imagen" class="filestyle" data-input="false" data-buttonText="Imagen" data-iconName="fa fa-picture-o" data-badge="false" data-type-file="imagen" data-validate="true" data-text="Imagen">
								<p class="help-block"><small>Solo se aceptan imagenes con formato .JPG, .JPEG, .PNG; La imagen debe ser menor a 8 MB. <br> La resolución óptima para esta imagen es de 1920 x 751px </small></p>
							</center>
							<!-- <center class="espacios">
			                ...
			                <div class="input-group espacios">
			                    <span class="input-group-addon">Frase superior izquierda</span>
			                    <input type="text" id="ubicacion" name="ubicacion" data-validate="false" class="form-control" placeholder="Ingresa la frase" value="">
			                </div>
	...
	<footer id="footer">
		...
		<script src="js/functionsTestimonio2.js"></script>
	</footer>
</html>
