...
$clave = 'p_add_journal';
$clave2 = 'p_del_journal';
$clave3 = 'p_acdc_journal';
$clave4 = 'p_sort_journal';
$sort = "blog";
$handle = "";
			                    ...
			                    <?php
									...
									?>	
											<tr>
				                                ...
				                                <td>
				                                	<a href="formBlog.php?idBlog=<?=$elementoTemporal['idBlog']?>"><img class="img-responsive" src="../img/blog/<?=$elementoTemporal['portada']?>"></a>
				                                </td>
				                                <td>
				                                	<a href="formBlog.php?idBlog=<?=$elementoTemporal['idBlog']?>">
				                                		<?=$elementoTemporal['titulo']?>
				                                	</a>
				                                </td>
				                                <td><?=$elementoTemporal['subtitulo']?></td>				                                
				                                <td><?=$elementoTemporal['tags']?></td>
