...
$listaTemporal = $temporal -> listaExperiencia(1, true, '', '35');
...
<html lang="es">
	<head>
		...
		<title>Lista | Precios 35 USD</title>
	</head>
	<body>
		<header>
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                        <p class="titulo">Precios 35 USD</p>
	                    </div>
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                    	<form action="formulario35.php" method="post" style="display:none">
                    	...
                    	<form method="post" action="operaciones.php">
                    		...
                    		<input type="hidden" id="filtroTipo" name="tipo" value="35">
                    		<div class="">
			                        ...
			                        <table id="table-short" class="table table-hover table-striped tablesorter">
					                    ...
					                    <?php
											...
											<tr>
				                                ...
				                                <td>
				                                	<a href="formulario35.php?id=<?=$elementoTemporal['idExperiencia']?>">
				                                		<?=$elementoTemporal['nombre']?> - <?=$elementoTemporal['nombreEn']?>
				                                	</a>
				                                </td>
