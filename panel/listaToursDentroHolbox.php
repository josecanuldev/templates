...
$listaTemporal = $temporal -> listaExperiencia(1, true, '', 'ToursDentroHolbox');
// print_r($listaTemporal);
// exit;

$clave  = 'p_add_yachting';
$clave2 = 'p_del_yachting';
$clave3 = 'p_acdc_yachting';
$clave4 = 'p_sort_yachting';
$clave5 = 'p_mod_yachting';
$sort   = "experiencia";
$handle = "";
...
<html lang="es">
	<head>
		...
		<title>Lista | Tours dentro de Holbox</title>
	</head>
	<body>
		<header>
            	...
            	<div class="page-content inset">
            		<div class="row rowedit">
	                    ...
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                        <p class="titulo">Tours dentro de Holbox</p>
	                    </div>
	                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
	                    	<form action="formularioToursDentroHolbox.php" method="post">
                    	...
                    	<form method="post" action="operaciones.php">
                    		...
                    		<input type="hidden" id="filtroTipo" name="tipo" value="ToursDentroHolbox">
                    		<div class="">
					                    ...
					                    <?php
											...
											<tr>
				                              	<td>
				                               	...
				                               	<td>
				                                	<a href="formularioToursDentroHolbox.php?id=<?=$elementoTemporal['idExperiencia']?>">
				                                		<img src="../img/imgToursDentroHolbox/<?=$elementoTemporal['imgPortada']?>" class="img-responsive">
				                                	</a>
				                                </td>
				                                <td>
				                                	<a href="formularioToursDentroHolbox.php?id=<?=$elementoTemporal['idExperiencia']?>">
