		...
		<div class="container pb-5 pt-3">
			...
			<div class="row">
				...
				<div class="col-md-6 align-items-center text-center">
					<h1 class="text-dark"> Operadores </h1>
			...
			<div class="row pb-3">
				<div class="col-md-3 col-sm-12">
					<label for="filter_dates" class="form-label">Filtrar por rango de fechas:</label>
					<select class="custom-select" id="tipo_rango" @change="changeRangeDate">
				...
				<div class="col-md-3 col-sm-12">
					<label for="filter_drivers" class="form-label">Filtrar por operador:</label>
					<select class="custom-select" id="id_operador" @change="changeAgency">
						<option value="0" selected>Todos</option>
						<?php $operadores = Drivers::model()->findAll(); ?>
						<?php foreach ($operadores as $val) { ?>
			...
			<div class="row mt-5">
				<div class="col-12 text-right">
					<div class="d-flex flex-row-reverse">
						<form action="<?php echo Yii::app()->createUrl('orders/getOrders'); ?>" method="get" id="form_pdf" target="_blank">
							<input type="hidden" name="fecha_de" id="fecha_de" />
							<input type="hidden" name="fecha_hasta" id="fecha_hasta" />
							<input type="hidden" name="type" id="typePdf" value="all" />
							<input type="hidden" name="tipoFecha" id="tipoFechaPdf" value="all" />
							<input type="hidden" name="id_agencia" id="0" />
...
Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/driversAgrupados.js?v='.time(), CClientScript::POS_END);
Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/driversAgrupados_kendo.js?v='.time(), CClientScript::POS_END);
?>